...
const emojiCategories = {
	...
	// Unicode 17.0 completeness pass — every single-codepoint emoji from the
	// Wikipedia "Unicode single emoji" table not already covered above.
	// Deduplication in generateCalendar() handles any overlaps.
	unicodeMissing: [
		// Basic / legacy symbols
		...
		// Clothing & medical (U+1FA7x)
		{ emoji: "🩴", name: "Thong Sandal" },
		{ emoji: "🩻", name: "X-Ray" },
		{ emoji: "🩼", name: "Crutch" },
		// Instruments & tools (U+1FA8x)
		{ emoji: "🪉", name: "Harp" },
		{ emoji: "🪊", name: "Accordion 2" },
		{ emoji: "🪎", name: "Fingerboard" },
		{ emoji: "🪏", name: "Shovel" },
		// Space & tools (U+1FA9x)
		...
		{ emoji: "🫪", name: "Face with Wide Eyes" },
		{ emoji: "🫯", name: "Face with One Eye" },
		// Hands (U+1FAFx)
