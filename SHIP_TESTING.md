...
6. **Solve a puzzle**
    ...
    - Click "View Trophies"
    - ✅ Stats dialog opens showing 0 trophies earned
...
1. **Sign in with Google**
    ...
    - Complete sign-in
    - ✅ You're signed in (see your name in header)

2. **Verify trophy migrated**
    - ✅ Trophy Case now shows 1 trophy (migrated from localStorage to Firestore)
